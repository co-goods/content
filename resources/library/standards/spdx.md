...
relevance_to_project: SPDX identifiers are the vocabulary we use for every `license:` and `work_license:` field across the content repo, and the source for the inline `[[license:<id>]]` reference.
key_points:
